...
<ul>
	...
	<input type = "text" name ="drinkname" size="60"></li>
	<li class="custom">
	<label for="custom">custom</label>
	<input type = "text" name ="custom" size="60"></li>
	<li class="file">
	<label for="file">image/video</label>
	<input type="file" name="upfile"></li>
	<li class="submit">
	<input type = "hidden" name = "pass" value="<?php echo "$postpass" ?>" >
	<input type="submit" id="submit" name="write" value="送信"></li></ul>
	</form>
<br /><br />
...
?>
	<a href="http://co-981.it.99sv-coco.com/mission_3-10_login.php">←戻る</a>
	</div>
	<br /><br />
